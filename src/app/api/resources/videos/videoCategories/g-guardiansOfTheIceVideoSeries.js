/**
 * @file g-guardiansOfTheIceVideos.js
 * @module Data/Video/guardiansOfTheIceVideos
 * @desc Contains video data for the "Guardians of the Ice" video series in Alberta Tomorrow.
 * 
...
export const guardiansOfTheIceVideos = [
  ...
  },
  {
    id: 4,
    title: "Bow Glacier",
    description:"Part of the Wapta Icefield,  the 3.5 square km Bow Glacier drains into Bow Lake.",
    category: VideoCategory.ICE_SERIES,
    tools: [AssociatedTool.SIMULATOR],     
