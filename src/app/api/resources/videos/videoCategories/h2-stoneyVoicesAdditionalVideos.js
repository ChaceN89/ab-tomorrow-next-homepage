/**
 * @file h2-stoneyVoicesAdditionalVideos.js
 * @module Data/Video/StoneyVoices
 * @desc Contains additional video data for the Stoney Voices category in Alberta Tomorrow (Set 2).
 * 
